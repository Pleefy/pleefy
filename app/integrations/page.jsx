      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-sm text-gray-600 block">Webhook (voor events)</label>
            <input className="w-full border rounded-xl p-3" value={cfg.webhook} onChange={e=>setCfg({...cfg, webhook:e.target.value})} placeholder="https://..." />
          </div>
